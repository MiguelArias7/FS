...
function Register() {
  ...
  useEffect(() => {
    if (departamentoSelect !== "" && !loadingLocationData) {
      setDepartamentos(getDepartamentos());
      setMunicipios(getMunicipios(departamentoSelect));
    }
  }, [departamentoSelect]);
  ...
  const fields = [
    {
      ...
      properties: {
        required: "Required",
        minLength: { value: 3, message: "Few characters" },
    ...
    },
    {
      ...
      properties: {
        required: "Required",
        minLength: { value: 10, message: "Few characters" },
        maxLength: { value: 20, message: "Too many characters" },
      },
    },
  ];
  ...
  const notificationRegister = () =>
    (toastId.current = toast.info("Registering user...", {
  ...
  const updateRegistrationFail = () =>
    toast.update(toastId.current, {
      render: "User registration failed",
        ...
        <div className="grid grid-cols-2 md:grid-cols-3">
          ...
          <form onSubmit={handleSubmit((data) => onSubmitForm(data))} autoComplete="off" className="col-span-2 animate-fade_right">
            <div className=" grid gap-1 mb-4">
              <h3 className="font-medium text-3xl text-secundary">Do you want to join us?</h3>
